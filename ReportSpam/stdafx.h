...
#pragma warning( disable : 4146 )
	...
	#import "libid:00062FFF-0000-0000-C000-000000000046" raw_interfaces_only named_guids

#pragma warning( default : 4146 )
#pragma warning( default : 4278 )

#define IfFailRH(hr) {if(FAILED(hr)) return hr;}
#define IfFailRV(hr) {if(FAILED(hr)) return;}
#define IfFailGo(x) { hr=(x); if (FAILED(hr)) goto Error; }
#define IfFailGoCheck(x, p) { hr=(x); if (FAILED(hr)) goto Error; if(!p) {hr = E_FAIL; goto Error; } }

class DECLSPEC_UUID("DD2111E8-DB85-471D-B37F-78AF2A85216B") ReportSpamLib;
...
public:
	...
	DECLARE_LIBID(__uuidof(ReportSpamLib))
